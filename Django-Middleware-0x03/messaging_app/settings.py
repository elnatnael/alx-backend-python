...
SECRET_KEY = 'django-insecure-yytn$a1s%^+339r%m9+yv&qw*__mqb$hslfu(l%zg8ufxo4_hf'
...
SIMPLE_JWT = {
    'USER_ID_FIELD': 'user_id',  # Tell SimpleJWT to use your UUID field
...
MIDDLEWARE = [
    ...
    'chats.middleware.RequestLoggingMiddleware',  # ✅ <-- This must be here
